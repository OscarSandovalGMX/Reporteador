...
Partial Class SiteMaster
    ...
    Public Property MuestraOpciones() As Boolean
        Get
            Return imgOpciones.Visible
        End Get
        Set(ByVal value As Boolean)
            imgOpciones.Visible = value
            lnk_Opciones.Visible = value
        End Set
    End Property

    Public Property Formato() As String
        Get
            Return optSalida.SelectedValue
        End Get
        Set(ByVal value As String)
            optSalida.SelectedValue = value
        End Set
    End Property

    Public Property MuestraBarra() As Boolean
        Get
            Return lbl_barra.Visible
        End Get
        Set(ByVal value As Boolean)
            lbl_barra.Visible = value
        End Set
    End Property
